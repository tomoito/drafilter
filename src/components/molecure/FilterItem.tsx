    ...
    <div className=" scrollbar-hide overflow-x-scroll flex w-screen space-x-3 whitespace-nowrap  items-center">
      {title.map(i => (
        <div
          ...
          className="bg-yellow-100 text-xs flex rounded-lg md:text-base h-auto p-1 text-center items-center transform duration-150 hover:scale-110 hover:bg-gray-500 cursor-pointer mb-2">
