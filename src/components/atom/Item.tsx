...
const Item: React.FC<Props> = ({ title, Pic }) => {
  ...
  return (
    <div className="flex flex-col w-16  md:w-auto md:max-w-md items-center cursor-pointer transform duration-150 hover:scale-105 mx-3 my-2">
      <div className="border border-gray-800 rounded-lg items-center  justify-center grid place-items-center h-30 w-30 ">
        <img src={`images/pic/${Pic}`} className=" md:w-32 md:h-32" />
      </div>
